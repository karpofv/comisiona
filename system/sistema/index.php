...
?>
            <script src="<?php echo $ruta_base;?>/assets/js/plugins/moment/moment.min.js"></script>
            <script src="<?php echo $ruta_base;?>/assets/js/plugins/calendario/calendario.min.js"></script>
            <script>
