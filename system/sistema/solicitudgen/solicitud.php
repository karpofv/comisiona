    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" method="post" action="javascript:void(0)" onsubmit="controler('dmn=<?php echo $idMenu;?>&codigo='+$('#codigo').val()+'&txtfecha='+$('#txtfecha').val()+'&descsol='+$('#descsol').val()+'&editar=1&ver=1', 'verContenido'); return false;">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <label class="control-label" for="descsol">Descripción de la solcitud</label>
                            <textarea class="form-control" id="descsol"><?php echo $descsol;?></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
    ...
    <div class="mail-box">
        <table class="table table-hover table-mail">
            <tbody>
                ...
                ?>
                <tr class="unread">
                    <td class="text-right"><?php echo $sol[sol_periodoacad];?></td>
